...
const GetInvolvedPage = () => {
  ...
  return (
    <div className="pt-16">
                ...
                <div className="flex justify-between mt-8">
                  {currentStep > 1 && (
                    <button
                      ...
                      className="px-6 py-3 border border-navy text-navy rounded-md hover:bg-gray-50 transition-colors"
                    >
                      Previous
                    </button>
                  )}
                  {currentStep < 3 ? (
                    <button
                      type="button"
                      onClick={() => setCurrentStep(prev => prev + 1)}
                      className="px-6 py-3 bg-navy text-white rounded-md hover:bg-teal transition-colors ml-auto"
                    >
                      Next
                    </button>
                  ) : (
      ...
      {/* CTA Section */}
      <section className="py-12 bg-[#D0D0FA] text-gray-900">
        <div className="container mx-auto px-4">
