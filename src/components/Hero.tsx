...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      {/* Content */}
      <div className="container mx-auto px-4 relative z-20 pt-32 md:pt-48 flex flex-col flex-grow">
        <div className="max-w-3xl space-y-8 mb-auto">
          ...
          {/* Updated button styles with exact colors and smaller size */}
        ...
        <div className="w-full mt-auto relative z-30 bg-navy py-6 mt-24 md:mt-32">
